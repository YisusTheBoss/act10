...
Podemos darle al entrenamiento 
diferentes parámetros para obtener 
un resultado que sea el optimo al 
combinar esas posibilidades. 
Algoritmos de ajuste de hyper parámetros
